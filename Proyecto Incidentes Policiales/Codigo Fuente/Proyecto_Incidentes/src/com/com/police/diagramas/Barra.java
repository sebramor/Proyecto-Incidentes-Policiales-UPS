...
public class Barra implements Serializable {
    ...
    public void createBarModel() {
        ...
        barDataSet.setLabel("Número de incidentes clasificados por tipo en una determinada fecha");
		...
		try {
			if(fecha!=null) {
				 q = em.createNativeQuery("select vist.tipo_incidente from vista_reporte as vist where dia = "+fecha.getDate()+" and mes = "+(fecha.getMonth()+1)+" and anio = "+(fecha.getYear()+1900)+" group by vist.tipo_incidente limit 7;;",VistaReporte.class);
				 reportes = (List<VistaReporte>) q.getResultList();
				 for (VistaReporte rep : reportes) {
