...
public class Conexion implements Serializable {
	...
	public static void listadoCuant() 
	{
		...
		DimIncidenteLlamada user = new DimIncidenteLlamada();
			...
			Query q = em.createNativeQuery("SELECT * from dim_incidente_llamadas, fact_incidente where dim_incidente_llamadas.sk_incidentes = fact_incidente.sk_incidentes and sk_fecha = '20160529' limit 7;", DimIncidenteLlamada.class);
			
			List<DimIncidenteLlamada> usuarios = (List<DimIncidenteLlamada>) q.getResultList();
			
			for (DimIncidenteLlamada usuario : usuarios) {
				System.out.println("Cantidad de incidentes: " + (usuario.getSkIncidentes()/1000));
				System.out.println("Tipo Incidente: " + usuario.getTipoIncidente());
			}
		em.close();
	}
